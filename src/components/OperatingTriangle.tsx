      ...
      >
        ...
        return (
          ...
          >
            ...
            <span
              className={`operating-node-title type-h4 absolute hidden whitespace-nowrap font-serif font-medium transition-colors duration-200 xl:block ${
        ...
        <div className="grid">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <h3 className="type-h4 mb-1 font-serif font-medium text-navy xl:hidden">
                  {item.title}
                </h3>
