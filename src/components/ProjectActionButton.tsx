...
export function ProjectActionButton({
  ...
  const className =
    "project-resource-button group/resource inline-flex h-11 max-w-11 items-center overflow-hidden rounded-full border px-0 transition-all duration-200 hover:max-w-48 hover:px-4 focus:max-w-48 focus:px-4";
  ...
  return (
    ...
    >
      <Icon className="project-resource-icon mx-[0.8125rem] h-4 w-4 flex-none transition-all duration-200 group-hover/resource:mx-0 group-focus/resource:mx-0" aria-hidden="true" />
      <span className="project-resource-label ml-0 max-w-0 overflow-hidden whitespace-nowrap text-sm font-bold opacity-0 transition-all duration-200 group-hover/resource:ml-2 group-hover/resource:max-w-32 group-hover/resource:opacity-100 group-focus/resource:ml-2 group-focus/resource:max-w-32 group-focus/resource:opacity-100">
        {label}
      </span>
    </a>
  );
