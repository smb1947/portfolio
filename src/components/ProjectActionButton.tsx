...
export function ProjectActionButton({
  ...
  return (
    <a
      ...
      className={`${className} border-iconBorder bg-iconSurface text-iconForeground shadow-sm hover:-translate-y-0.5 hover:border-teal/40 hover:bg-teal hover:text-white focus:outline-none focus:ring-4 focus:ring-teal/20`}
    >
