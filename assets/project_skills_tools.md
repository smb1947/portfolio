...
Reference list for project-level skills and tools. The website currently keeps these fields in `src/lib/content.json` but does not display them on project cards.
...
| Figma Product Design Work | Interaction design; Journey mapping; Wireframing | Figma; UX artifacts; Interface concepts |
| WSLBlobNFS PowerShell Module and Package Distribution | 0-to-1 development; Developer experience; GTM partnership | PowerShell; WSL2; PowerShell Gallery |
| BlobNFS Troubleshooting Tool | Diagnostics; Support tooling; Root-cause analysis | Azure Blob NFS; Troubleshooting scripts; Log collection |
| Sketch-to-Image GenAI Tool | Computer vision; Generative AI; Image generation | CNN; GAN; Python |
